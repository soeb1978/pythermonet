...
def run_dimensioning():
    ...
    #     print(f'Required length of each of the {int(HHE.N_HHE)} horizontal loops = {int(np.ceil(L_HHE_H/HHE.N_HHE))} m for heating');
    #     print(f'Required length of each of the {int(HHE.N_HHE)} horizontal loops = {int(np.ceil(L_HHE_C/HHE.N_HHE))} m for cooling');
