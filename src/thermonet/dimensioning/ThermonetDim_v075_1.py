...
if SS == 1:                                     
    ...
    Rb_H = RbMP(l_f,l_p,l_g,l_ss,r_b,r_p,ri,s_BHE,Re_BHEmax_H,Pr);                # Compute the borehole thermal resistance (m*K/W)
    Rb_C = RbMP(l_f,l_p,l_g,l_ss,r_b,r_p,ri,s_BHE,Re_BHEmax_C,Pr);                # Compute the borehole thermal resistance (m*K/W)
    ...
    for i in range(NLBHEHv):                                         # Compute Rb for the specified number of boreholes and lengths considering flow and length effects (m*K/W)
        Rb_H_v[i] = RbMPflc(l_f,l_p,l_g,l_ss,rho_f,c_f,r_b,r_p,ri,L_BHE_H_v[i],s_BHE,Q_BHEmax_H,Re_BHEmax_H,Pr);    # Compute BHE length and flow corrected multipole estimates of Rb for all candidate solutions (m*K/W)
    ...
    for i in range(NLBHECv):                                         # Compute Rb for the specified number of boreholes and lengths considering flow and length effects (m*K/W)
        Rb_C_v[i] = RbMPflc(l_f,l_p,l_g,l_ss,rho_f,c_f,r_b,r_p,ri,L_BHE_C_v[i],s_BHE,Q_BHEmax_C,Re_BHEmax_C,Pr);    #K. Compute BHE length and flow corrected multipole estimates of Rb for all candidate solutions (m*K/W)
        # KART: beregn væske temperatur
