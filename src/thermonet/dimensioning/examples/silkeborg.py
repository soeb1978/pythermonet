...
if __name__ == '__main__':
    ...
    T0_BHE = 8.39
    source_config = BHEconfig(q_geo = 0.0185, T0=T0_BHE, r_b=0.152/2, r_p=0.02, SDR=11, l_ss=2.36, rhoc_ss=2.65e6, l_g=1.75, rhoc_g=3e6, D_pipes=0.015, NX=1, D_x=15, NY=6, D_y=15);
