...
import pandas as pd
from pythermonet.core.thermonet_classes import Brine, Thermonet, Heatpump, BHEconfig
from pythermonet.core.dimensioning_functions import read_heatpumpdata, read_topology
...
if __name__ == '__main__':
    ...
    # Input files
    HP_file = '../examples/silkeborg_bhe_full_dimensioning_heat/data/silkeborg_heat_pump_heat.dat'
    TOPO_file = '../examples/silkeborg_bhe_full_dimensioning_heat/data/silkeborg_topology.dat'               # Input file containing topology information
    pipe_file = r'c:\Users\kri\Documents\OneDrive - ViaUC\local_documents\pythermonet\src\thermonet\dimensioning\data\equipment\PIPES.dat'                   # Input file with available pipe diameters
